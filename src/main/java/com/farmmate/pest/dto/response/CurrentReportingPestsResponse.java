...
public record CurrentReportingPestsResponse(
	...
	@Schema(description = "주의", defaultValue = "주의 중인 병해충 목록") List<String> advisories, // 주의
	...
	public static CurrentReportingPestsResponse fromVo(CurrentReportingPestsVo vo) {
		return new CurrentReportingPestsResponse(vo.forecasts(), vo.advisories(), vo.warnings());
	}
}
